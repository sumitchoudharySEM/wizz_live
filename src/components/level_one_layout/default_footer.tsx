  ...
  return (
    <footer className="bg-white px-4">
      <div className="container px-6 py-7 mx-auto">
        <div className="grid grid-cols-1 gap-13 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-5">
          <div className="mr-11">
            ...
            <p className="text-gray-600 text-base font-normal">
              ...
              best Solana companies in on place and apply to them using a single
              profile
            </p>
          </div>
          ...
          <div className="sm:col-span-2">
            <p className="max-w-lg text-lg font-normal tracking-tight text-gray-800 xl:text-2xl ">
            ...
            <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
              <input
                id="email"
                type="text"
                className="px-4 mr-4 py-2 rounded-full text-gray-700 bg-white border focus:border-green-400 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-green-500"
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex -mx-2">
            ...
            <a
              href="#"
              className="mx-2 text-gray-600 transition-colors duration-300  hover:text-green-600"
              aria-label="Facebook"
            >
              <svg
